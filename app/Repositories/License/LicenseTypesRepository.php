...
use App\Models\License\LicenseType; // Ensure this is the correct model
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Collection;
use App\Repositories\CustomBaseRepository;
use DB;

class LicenseTypesRepository extends CustomBaseRepository
{
    /**
    ...
    {
        return LicenseType::class; // Ensure this matches your model
    }
