    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="page-header mb-4">
                ...
                <p>Add details for a new visitor.</p>
            </div>

            <!-- Form Card -->
            <div class="card custom-card">
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('pfps.visitors.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('home_address') is-invalid @enderror" 
                                      id="home_address" name="home_address">{{ old('home_address') }}</textarea>
                            @error('home_address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('organization_id') is-invalid @enderror" 
                                ...
                                @foreach ($organizations as $id => $organization)
                                    <option value="{{ $id }}" 
                                            {{ old('organization_id') == $id ? 'selected' : '' }}>
                                        {{ $organization }}
                                    </option>
                                @endforeach
                            </select>
