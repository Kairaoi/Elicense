    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="page-header mb-4">
                <h1>Edit Fishing Duration</h1>
                <p>Update details for the selected fishing duration.</p>
            </div>

            <!-- Form Card -->
            <div class="card custom-card">
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('pfps.durations.update', $duration->duration_id) }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="duration_name" 
                                   name="duration_name" 
                                   value="{{ old('duration_name', $duration->duration_name) }}" 
                                   required>
                            @error('duration_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="fee_amount" 
                                   name="fee_amount" 
                                   value="{{ old('fee_amount', $duration->fee_amount) }}" 
                                   required step="0.01">
                            @error('fee_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
