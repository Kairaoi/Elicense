    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="page-header mb-4">
                <h1>Create Equipment Rental</h1>
                <p>Fill in the details to create a new equipment rental record.</p>
            </div>

            <!-- Form Card -->
            <div class="card custom-card">
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('pfps.equipment_rentals.store') }}">
                        @csrf
