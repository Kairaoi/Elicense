    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="page-header mb-4">
                <h1>Edit Lodge</h1>
                <p>Update details for the selected lodge.</p>
            </div>

            <!-- Form Card -->
            <div class="card custom-card">
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('pfps.lodges.update', $lodge->lodge_id) }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="lodge_name" 
                                   name="lodge_name" 
                                   value="{{ old('lodge_name', $lodge->lodge_name) }}" 
                                   required>
                            @error('lodge_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="location" 
                                   name="location" 
                                   value="{{ old('location', $lodge->location) }}">
                            @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
