    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('reference.species.update', $species->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" 
                                    name="name" value="{{ old('name', $species->name) }}" required autofocus>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                <select id="license_type_id" class="form-control @error('license_type_id') is-invalid @enderror" 
                                    ...
                                    @foreach($licenseTypes as $id => $type)
                                        <option value="{{ $id }}" 
                                            {{ old('license_type_id', $species->license_type_id) == $id ? 'selected' : '' }}>
                                            {{ $type }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="quota" type="number" step="0.01" class="form-control @error('quota') is-invalid @enderror" 
                                    name="quota" value="{{ old('quota', $species->quota) }}" required>
                                @error('quota')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="unit_price" type="number" step="0.01" class="form-control @error('unit_price') is-invalid @enderror" 
                                    name="unit_price" value="{{ old('unit_price', $species->unit_price) }}" required>
                                @error('unit_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
