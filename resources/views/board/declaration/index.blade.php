...
<div class="container my-5">
    ...
    <div class="text-center mb-5">
        <h1 class="display-4">Marine Product Consigment </h1>
    ...
    <ul class="nav nav-pills mb-4 justify-content-center">
        @foreach ([ 
            ['id' => 'declarations', 'title' => 'Declarations', 'icon' => 'bi bi-person'],
    ...
    <div class="tab-content">
        @foreach ([ 
            ['id' => 'declarations', 'title' => 'Declarations', 'description' => 'View and manage sea cucumber export license declarations.', 'route' => 'export.declarations.index'],
