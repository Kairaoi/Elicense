...
<div class="container my-5">
    ...
    <div class="text-center mb-5">
        <h1 class="display-4">Quota Licenses Registry</h1>
    ...
    <div class="tab-content">
        @foreach ([ 
            ['id' => 'licenses', 'title' => 'Licenses', 'description' => 'View and manage sea cucumber export licenses.', 'route' => 'license.licenses.index'],
        ] as $tab)
